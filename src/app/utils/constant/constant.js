...
image:images.dave},
{
   quote:'The AI algorithm is crazy good, it chooses the right meals for me every time. It is amazing not to worry about food anymore!' ,
   name:'Ben Hadley',
   image:images.ben
},
{
    quote:'Omnifood is a life saver! I just started a company, so there is no time for cooking. I couldn not live without my daily meals now!',
    name:'Steve Miller',
    image:images.steve
},
{
...
export const galleryImages=[images.gallery_1,images.gallery_2,images.gallery_3,images.gallery_4,images.gallery_5,images.gallery_6,images.gallery_7,images.gallery_8,images.gallery_9,images.gallery_10,images.gallery_11,images.gallery_12];
    ...
    */
    {
        name:'Starter',
        price:399,
        text:"That's just $13 per meal!",
        features:["1 meal per day","Order times are between 11am and 9pm","Delivery is free"]
    },
    {
        name:'Complete',
        price:649,
        text:"That's just $11 per meal!",
        features:["2 meal2 per day","Order 24/7","Delivery is free","Get access to latest recipes"]
    }
];
...
export const footerNav=[
    {
        title:'Account',
        nav:['Create Account','Sign in','iOS app','Android app']
    },
    {
        title:'Company',
        nav:['About Omnifood','For business','Cooking partners','Carrer']
    },
    {
        title:'Resources',
        nav:['Recipe directory','Help Center','Privacy & terms']
    }
]
